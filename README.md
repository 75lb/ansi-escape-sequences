...
* [ansi-escape-sequences](#module_ansi-escape-sequences)
    ...
    * [.cursor](#module_ansi-escape-sequences.cursor) : <code>object</code>
        * [.hide](#module_ansi-escape-sequences.cursor.hide) : <code>string</code>
        * [.show](#module_ansi-escape-sequences.cursor.show) : <code>string</code>
    ...
    * [.erase](#module_ansi-escape-sequences.erase) : <code>object</code>
...
### ansi.cursor : <code>object</code>
cursor-related sequences

**Kind**: static namespace of <code>[ansi-escape-sequences](#module_ansi-escape-sequences)</code>  
